...
$applicationManifest = Join-Path $buildRoot 'application.manifest'
...
'@
[IO.File]::WriteAllText($applicationManifest, $manifestResource, (New-Object Text.UTF8Encoding($false)))
